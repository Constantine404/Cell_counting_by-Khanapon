...
![Example image](Detected.png)
---

## 🔹 ผลลัพธ์
ยังมีเซลล์ที่ไม่สามารถตรวจจับได้ เพราะเมื่อมาสังเกคุที่ภาพ Original จะเป็นจุดที่มีภาพเบลอหรือมีอะไรสักอย่างมาบัง เมื่อทำการ Contrast จะได้เป็นจุดสีดำขนาดมใหญ่ ซึ่งจากโปรแกรมนี้ตั้งค่าพารามิเตอร์ให้รับแค่จุดที่มีขนาด 0.05-100 เท่านั้นทำให้ไม่สามารถนับเซลล์นั้นได้ 
